...
public class PlayerUpdateCard extends JPanel {
    ...
    public void run() {
        ...
        pname = player.getPlayerComboBox();
        JComboBox<String> pbox = player.getPositionComboBox();
        JComboBox<String> tbox = player.getTeamComboBox();
