...
public class Rush_Stats_Ins {
    ...
    public void createStat(String p, int ra, int ry, int rt) {
        System.out.print("This is the player : " + p + "  --rush attempts: " + ra + " --rush yards: " + ry + " --rushtds: " + rt);
        /*   PreparedStatement stmt = null;

        try {
            stmt = conn.prepareStatement("Insert into RUSHING_STATISTICS(player_name, rush_att, rush_yds, rush_td) values(?,?,?,?)");
